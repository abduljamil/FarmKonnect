...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Image, Dimensions, SafeAreaView, StatusBar, TextInput, ActivityIndicator, RefreshControl } from 'react-native';
    ...
    <SafeAreaView style={styles.root}>
      ...
      >
        ...
        {loading ? (
          ...
          <Text style={{ color: '#fff', textAlign: 'center', marginTop: 20 }}>No listings found.</Text>
        ) : (
