...
import { Copy, Check, MessageSquare, AlertTriangle, Package, CreditCard, CheckCircle, XCircle, Camera, X, Image, ArrowLeft } from "lucide-react";
    ...
    return (
        <div className={`min-h-screen ${isDark ? "bg-gray-900 text-gray-100" : "bg-gray-50 text-gray-900"} pt-16 sm:pt-20`}>
            ...
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                  <button
                      onClick={handleBack}
                      className={`mb-6 flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-full transition-all duration-200 shadow-sm border w-fit ${isDark
                              ? "bg-gray-800 text-gray-300 border-gray-700 hover:text-white hover:bg-gray-700 hover:border-gray-600"
