    ...
    <SafeAreaView style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => open('mailto:support@farmkonnect.app')}>
          <View style={styles.iconBox}><Mail color={COLORS.primary} size={22} /></View>
        ...
        <TouchableOpacity style={styles.card} onPress={() => open('tel:+923001234567')}>
          <View style={styles.iconBox}><PhoneCall color={COLORS.primary} size={22} /></View>
          <View style={styles.cardBody}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Support')}>
          <View style={styles.iconBox}><MessageSquare color={COLORS.primary} size={22} /></View>
          <View style={styles.cardBody}>
...
const styles = StyleSheet.create({
  ...
  lead: { color: COLORS.textMuted, fontSize: 14, marginBottom: 20, lineHeight: 20 },
  card: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(26, 46, 29, 0.5)', padding: 16, borderRadius: 16, borderWidth: 1, borderColor: COLORS.border, marginBottom: 12, gap: 14 },
  ...
  cardLink: { color: COLORS.primary, fontSize: 13, marginTop: 2 },
